...
int main(int argc, char *argv[])
{
    ...
    options
        ...
        ("s-0", "The maximum value of a spread", cxxopts::value<double>(), "S_0")
        ("max-mutation", "The maximum change of a spread value or a center value in mutation", cxxopts::value<double>(), "M")
